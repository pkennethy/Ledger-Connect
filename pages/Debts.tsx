            ...
            periodTxns.forEach(txn => {
                ...
                if (txn.type === 'DEBT' && txn.items && txn.items.length > 0) {
                    txn.items.forEach((item: OrderItem) => { 
                        ...
                        smsBody += `  - ${item.productName} x${item.quantity} (P${itemTotal.toLocaleString()})\n`; 
                    });
                }
